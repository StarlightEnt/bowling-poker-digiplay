  ...
  return (
    <div style={{ padding: 24, maxWidth: 600 }}>
      ...
      <div style={{ background: SURFACE, border: `1px solid ${BORDER}`,
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            {BG_SWATCHES.map(c => (
              <button key={c} onClick={() => setThemeBackground(c)} style={{
                ...
                border: `2px solid ${themeBackground === c ? '#e8ff47' : '#555577'}`,
                cursor: 'pointer',
              }} title={c} />
            ))}
          </div>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            {ACCENT_SWATCHES.map(c => (
              <button key={c} onClick={() => setThemeAccent(c)} style={{
                width: 28, height: 28, borderRadius: '50%', background: c,
                border: `2px solid ${themeAccent === c ? '#ffffff' : '#555577'}`,
                cursor: 'pointer',
              }} title={c} />
            ))}
          </div>
        ...
        {savedAppearance && (
          <div style={{ color: '#3dffa0', fontSize: 12, marginBottom: 8 }}>✅ Appearance saved</div>
        )}
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
          ...
          <div
            ...
            <div style={{
              ...
              background: managerEnabled && isPaid ? '#1a1a2e' : '#555577',
          ...
          <div style={{ borderTop: `1px solid ${BORDER}`, paddingTop: 12, marginTop: 4 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 12 }}>
              <div style={{ width: 8, height: 8, borderRadius: '50%',
                background: apiKey ? '#3dffa0' : '#555577' }} />
              <span style={{ color: apiKey ? '#3dffa0' : '#8888aa', fontSize: 12 }}>
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
              ...
              {apiKey && (
                <button onClick={handleCopyKey} style={{
                  background: 'transparent', color: copied ? '#3dffa0' : '#8888aa',
      ...
      <div style={{ background: SURFACE, border: `1px solid ${BORDER}`,
        ...
        <div style={{ display: 'inline-block', background: isPaid ? '#0a2a1a' : '#1a1a2e',
          border: `1px solid ${isPaid ? '#3dffa0' : BORDER}`,
          borderRadius: 4, padding: '4px 10px', fontSize: 12, fontWeight: 700,
          color: isPaid ? '#3dffa0' : '#8888aa', marginBottom: 8 }}>
          {isPaid ? 'PAID' : 'FREE'}
        </div>
      ...
      <div style={{ background: SURFACE, border: `1px solid ${BORDER}`,
        ...
        {!showAddAdmin ? (
          <button
            ...
            disabled={!isPaid}
            style={{
              background: 'transparent', color: isPaid ? '#8888aa' : '#555577',
              border: `1px solid ${isPaid ? BORDER : '#333355'}`,
        ...
        {!isPaid && (
          <p style={{ color: '#555577', fontSize: 11, marginTop: 8 }}>
