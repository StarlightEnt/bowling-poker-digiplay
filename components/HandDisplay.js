...
export default function HandDisplay({ hand, gameNumber, isSubmitted, isForfeited, cardSize = 'md', showSubmitButton = false, onSubmit }) {
  ...
  return (
    <div style={{
      ...
      {/* Hand label */}
      <div style={{ fontSize: 10, color: '#666688', letterSpacing: 2, textTransform: 'uppercase', marginBottom: 3 }}>
      ...
      {hasCards ? (
        <>
          ...
          {showSubmitButton && (
            <div style={{ color: '#555577', fontSize: 11, marginTop: -4, marginBottom: 8 }}>
          ...
          {best5.length > 0 && (
            <div>
              <div style={{ fontSize: 10, color: '#888899', textTransform: 'uppercase',
          ...
          {totalCards > 0 && (
            <div style={{ fontSize: 10, color: '#555577', textAlign: 'right', marginTop: 6 }}>
